...
<ul class="mt-20">
<li><a href="javascript:void(0)"><i class="flaticon-mobile"></i>+1 (850) 343-1419</a></li>

<li><a href="javascript:void(0)"><i class="flaticon-mail"></i> 
info@imperielpremium.com
</a></li>
...
<li><a href="javascript:void(0)">Apply Online</a></li>
    ...
    <div class="copyright text-center mt-50">
        ...
        <div class="row">
        <div class="col-12">
        <p class="copyright-text mb-0">All Rights Reserved 2022 <a href="javascript:void(0)/" rel="nofollow">Imperial Premium Bank </a>
                    </p>
                </div>
            </div>
        </div>
...
<!-- Scroll Top End -->
<script src="//code.tidio.co/tieaxaqkfiu1wyvlzqykmw6uvcqhllyk.js" async></script>
<!-- JS here -->
